...
void draw() {
  ...
  if (editNum == 0) {
    ...
    if (downloaded) {
      ...
      //textSize(20);
      //text("wooo", 40*3,70*3);
      println("ABOUT TO SAVE LOGO");
      saveLogo(userName, userLogoHash);
      println("NOW WE ARE BACK IN DRAW");
    }
    else {
      fill(c1);
      textSize(16);
    ...
    if (viewAlphabet && !editColor && !string2shape && !helpMode) {
      //BACK button
      stroke(c1);
      fill(c1);
    ...
    else if (editColor && !viewAlphabet && !string2shape && !helpMode) {
      //draw BACK button
      stroke(c1);
      fill(c1);
      rect(5*3,5*3,40*3,5*3);
    ...
    else if (string2shape && !editColor && !viewAlphabet && !helpMode) {
      //draw BACK button
      stroke(c1);
      fill(c1);
      rect(5*3,5*3,40*3,5*3);
    ...
    else if (helpMode && !string2shape && !editColor && !viewAlphabet) {
      //draw BACK button
      stroke(c1);
      fill(c1);
      rect(5*3,5*3,40*3,5*3);
...
void mouseClicked() {
  ...
  if (mouseX >= 5*3 && mouseX <= 45*3 && mouseY >= 5*3 && mouseY <= 10*3 && !viewAlphabet && !editColor && !string2shape && !helpMode) {
    viewAlphabet = true;
    editColor = false;
    string2shape = false;
    helpMode = false;
  ...
  else if (mouseX >= 105*3 && mouseX <= 145*3 && mouseY >= 5*3 && mouseY <= 10*3 && !viewAlphabet && !editColor && !string2shape && !helpMode) {
    editColor = true;
    viewAlphabet = false;
    string2shape = false;
    helpMode = false;
  ...
  else if (mouseX >= 55*3 && mouseX <= 95*3 && mouseY >= 5*3 && mouseY <= 10*3 && !viewAlphabet && !editColor && !string2shape && !helpMode) {
    string2shape = true;
    viewAlphabet = false;
    editColor = false;
    helpMode = false;
  ...
  //help + back buttons
  else if (mouseX >= 155*3 && mouseX <= 195*3 && mouseY >= 5*3 && mouseY <= 10*3 && !viewAlphabet && !editColor && !string2shape && !helpMode) {
    helpMode = true;
    string2shape = false;
    viewAlphabet = false;
    editColor = false;
...
void saveLogo(String userName, int userLogoHash) {
  ...
  /*
  println("IN THE SAVELOGO FUNCTION");
  String[] newUserData = new String[usrSize+1];
  //add old data
  for (int i = 0; i < usrSize; i++) {
    println("trying to add this: " + allUsr[i][0] + "," + allUsr[i][1]);
    newUserData[i] = allUsr[i][0] + "," + allUsr[i][1];
    println("newUserData row " + i + ": " + newUserData[i]);
  }
  //add new data
  allUsr = new int[usrSize+1][2];
  allUsr[usrSize][0] = userName;
  allUsr[usrSize][1] = userLogoHash;
  newUserData[usrSize] = allUsr[usrSize][0] + "," + allUsr[usrSize][1];
  println("the new user data is: " + newUserData[usrSize]);
  usrSize++;
  //reload user data
  //blah
  saveStrings("users.txt",newUserData);
  println("WRITTEN???");
  */
}
...
int[] snapToGrid(int x, int y) {
  ...
  /*
  if (x >= 60 && x <= 74 && y >= 60 && y <= 74) {
    snapped[0] = 60;
    snapped[1] = 60;
  }
  else if (x >= 75 && x <= 104 && y >= 60 && y <= 74) {
    snapped[0] = 90;
    snapped[1] = 60;
  }
  else if (x >= 105 && x <= 134 && y >= 60 && y <= 74) {
    snapped[0] = 120;
    snapped[1] = 60;
  }
  else if (x >= 135 && x <= 164 && y >= 60 && y <= 74) {
    snapped[0] = 150;
    snapped[1] = 60;
  }
  else if (x >= 165 && x <= 180 && y >= 60 && y <= 74) {
    snapped[0] = 180;
    snapped[1] = 60;
  }
  */
  //ROW 2
  /*
   if (x >= 60 && x <= 74 && y >= 75 && y <= 104) {
    snapped[0] = 60;
    snapped[1] = 90;
  }
  else if (x >= 75 && x <= 104 && y >= 75 && y <= 104) {
    snapped[0] = 90;
    snapped[1] = 90;
  }
  else if (x >= 105 && x <= 134 && y >= 75 && y <= 104) {
    snapped[0] = 120;
    snapped[1] = 90;
  }
  else if (x >= 135 && x <= 164 && y >= 75 && y <= 104) {
    snapped[0] = 150;
    snapped[1] = 90;
  }
  else if (x >= 165 && x <= 180 && y >= 75 && y <= 104) {
    snapped[0] = 180;
    snapped[1] = 90;
  }
  //ROW 3
  else if (x >= 60 && x <= 74 && y >= 105 && y <= 134) {
    snapped[0] = 60;
    snapped[1] = 120;
  }
  else if (x >= 75 && x <= 104 && y >= 105 && y <= 134) {
    snapped[0] = 90;
    snapped[1] = 120;
  }
  else if (x >= 105 && x <= 134 && y >= 105 && y <= 134) {
    snapped[0] = 120;
    snapped[1] = 120;
  }
  else if (x >= 135 && x <= 164 && y >= 105 && y <= 134) {
    snapped[0] = 150;
    snapped[1] = 120;
  }
  else if (x >= 165 && x <= 180 && y >= 105 && y <= 134) {
    snapped[0] = 180;
    snapped[1] = 120;
  }
  //ROW 4
  else if (x >= 60 && x <= 74 && y >= 135 && y <= 164) {
    snapped[0] = 60;
    snapped[1] = 150;
  }
  else if (x >= 75 && x <= 104 && y >= 135 && y <= 164) {
    snapped[0] = 90;
    snapped[1] = 150;
  }
  else if (x >= 105 && x <= 134 && y >= 135 && y <= 164) {
    snapped[0] = 120;
    snapped[1] = 150;
  }
  else if (x >= 135 && x <= 164 && y >= 135 && y <= 164) {
    snapped[0] = 150;
    snapped[1] = 150;
  }
  else if (x >= 165 && x <= 180 && y >= 135 && y <= 164) {
    snapped[0] = 180;
    snapped[1] = 150;
  }
  //ROW 5
  else if (x >= 60 && x <= 74 && y >= 165 && y <= 180) {
    snapped[0] = 60;
    snapped[1] = 180;
  }
  else if (x >= 75 && x <= 104 && y >= 165 && y <= 180) {
    snapped[0] = 90;
    snapped[1] = 180;
  }
  else if (x >= 105 && x <= 134 && y >= 165 && y <= 180) {
    snapped[0] = 120;
    snapped[1] = 180;
  }
  else if (x >= 135 && x <= 164 && y >= 165 && y <= 180) {
    snapped[0] = 150;
    snapped[1] = 180;
  }
  else if (x >= 165 && x <= 180 && y >= 165 && y <= 180) {
    snapped[0] = 180;
    snapped[1] = 180;
  }
  */
